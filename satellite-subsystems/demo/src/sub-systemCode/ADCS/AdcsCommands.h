...
#define SET_MOMENT_INERTIA_DATA_LENGTH 		24
...
#define GET_ADCS_EST_ANG_CMD_ID				146
#define GET_ADCS_EST_ANG_DATA_LENGTH		6

#define ADCS_GET_SATELLITE_POSITION_CMD_ID	150
#define ADCS_GET_SATELLITE_POSITION_DATA_LENGTH	6

#define GET_ADCS_EST_ANG_RATE_CMD_ID		147
#define GET_ADCS_EST_ANG_RATE_DATA_LENGTH	6

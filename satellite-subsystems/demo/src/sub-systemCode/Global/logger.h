...
typedef enum {
	LOG_ERR_GET_TIME = 0,
	LOG_ERR_FRAM_WRITE = 1,
	LOG_ERR_FRAM_READ = 2,
	LOG_ERR_ENTER_FS = 3,
	LOG_ERR_RELEASE_FS = 4,
	...
	LOG_ERR_TRXVU_SET_BITRATE = 300,
	LOG_ERR_TRXVU_IDLE_STATE = 301,
	LOG_ERR_TRXVU_INITIALIZE = 302,
	LOG_ERR_TRXVU_GET_FRAME_COUNT = 303,
	LOG_ERR_TRXVU_SEND_FRAM = 304,
	LOG_ERR_TRXVU_GET_FRAM = 305,
	LOG_ERR_TRXVU_I2C_TRANSPONDER = 306,
	LOG_ERR_TRXVU_SOFT_RESET = 307,
	LOG_ERR_TRXVU_HARD_RESET = 308,

	LOG_ERR_EPS_SOFT_RESET = 400,
	LOG_ERR_EPS_HARD_RESET = 401,

	LOG_ERR_ADCS_SOFT_RESET = 500,
	LOG_ERR_ADCS_HARD_RESET = 501,

	LOG_ERR_HARD_RESET_ANTS = 600
} log_errors;

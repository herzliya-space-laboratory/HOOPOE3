...
typedef enum _log_errors_COMM{
	...
	LOG_ERR_COMM_FRAM_READ_BITRATE = 42,
	LOG_ERR_COMM_FRAM_READ_BEACON = 43,
	LOG_ERR_COMM_FRAM_RESET_VALUE = 44,
	LOG_ERR_I2C_TRANSPONDER = 45,
	LOG_ERR_I2C_TRANSPONDER_RSSI = 46,
